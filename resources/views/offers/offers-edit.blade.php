            ...
            <div class="form-row">
               <div class="col-auto my-1"  {{ $errors->has('type_object') ? ' has-error' : '' }}>
                  ...
                  <select class="custom-select mr-sm-2" id="type_object" name = "type_object">
                     <option selected value="{{old('type_object')}}"></option>
            ...
            <div class="row" style="padding-top: 30px;">
               ...
               <div class="col">
                  <div class="form-group" {{ $errors->has('number_rooms') ? ' has-error' : '' }}>
                     ...
                     <input type="text" value="{{old('number_rooms')}}" name="number_rooms" class="form-control" id="number_rooms" placeholder="Ведіть кількість кімнат" style="float: right; width: 250px">
                  </div>
